...
// Service role key ile mobile uygulamanın veritabanına bağlan (ENV)
const supabase = createClient(
  process.env.NEXT_PUBLIC_SUPABASE_URL,
  process.env.SUPABASE_SERVICE_ROLE_KEY
);

async function cleanupMobileDbService() {
  console.log('🧹 Service role ile mobile uygulamanın veritabanını temizliyorum...');
...
cleanupMobileDbService().catch(console.error);
