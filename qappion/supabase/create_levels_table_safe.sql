-- Create levels table for user level management (Safe Version)
...
ALTER TABLE public.levels 
ADD COLUMN IF NOT EXISTS mission_count integer NOT NULL DEFAULT 0;

ALTER TABLE public.levels 
ADD COLUMN IF NOT EXISTS avg_points integer NOT NULL DEFAULT 0;
...
SET 
  ...
  mission_count = 0,
  avg_points = 0
WHERE product_count IS NULL OR mission_count IS NULL OR avg_points IS NULL;
