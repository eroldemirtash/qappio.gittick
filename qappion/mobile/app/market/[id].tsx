...
import { View, Text, ScrollView, StyleSheet, Pressable, Image, Dimensions, Modal, Linking } from 'react-native';
        ...
        <View style={styles.purchaseSection}>
          <View style={styles.pointsContainer}>
            <View style={styles.pointsItem}>
              <Text style={styles.pointsLabel}>Qappio Puanım</Text>
              <View style={styles.qpValueContainer}>
                ...
                >
                  <Text style={styles.qpValueText}>9850 QP</Text>
                </LinearGradient>
              </View>
            </View>
            <View style={styles.pointsItem}>
