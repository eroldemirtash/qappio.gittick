-- Brands ve brand_profiles tablolarını tamamen düzelt
...
-- 9. Test verisi ekle
INSERT INTO public.brands (name, email, category, description) VALUES
('Nike', 'info@nike.com', 'Sportswear', 'Just Do It'),
('Adidas', 'info@adidas.com', 'Sportswear', 'Impossible is Nothing'),
('Apple', 'info@apple.com', 'Technology', 'Think Different'),
('Samsung', 'info@samsung.com', 'Technology', 'Innovation for Everyone');
